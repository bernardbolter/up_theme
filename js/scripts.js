...
// hashtags.
// twitterFetcher.fetch('471362087331962880', 'twit_cap', 1, false, false, false, dateFormatter, false, '', false);
...
twitterFetcher.fetch('471362087331962880', 'twit_cap', 1, false, false, false, '', false, handleTweets, false);

function handleTweets(tweets){
    var x = tweets.length;
    var n = 0;
    var element = document.getElementById('twit_cap');
    var html = '<ul>';
    while(n < x) {
      html += '<li>' + tweets[n] + '</li>';
      n++;
